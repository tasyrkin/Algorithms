...
public class GraphsTest {
    ...
    public void testNumOfPaths() throws Exception {
        ...
        assertThat(numOfPaths(createGraph(4, 0, 1, 0, 2, 0, 3, 1, 2, 2, 3, 1, 3), 0, 3), is(new Graphs.NumPathsResult(4L, 3L)));
        assertThat(numOfPaths(createGraph(5, 0, 1, 0, 2, 1, 2, 1, 3), 0, 4), is(new Graphs.NumPathsResult(0L, 0L)));
        assertThat(numOfPaths(createGraph(6, 0, 1, 0, 2, 1, 2, 1, 3, 2, 4, 4, 5), 0, 5), is(new Graphs.NumPathsResult(2L, 1L)));
    }
}